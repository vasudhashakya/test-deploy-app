...
class VacationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vacation" do
    assert_difference('Vacation.count') do
      post vacations_url, params: { vacation: { end-date: @vacation.end-date, start-date: @vacation.start-date, status: @vacation.status, worker-email: @vacation.worker-email } }
    end
  ...
  test "should update vacation" do
    patch vacation_url(@vacation), params: { vacation: { end-date: @vacation.end-date, start-date: @vacation.start-date, status: @vacation.status, worker-email: @vacation.worker-email } }
